...
typedef enum
{
    ...
    TIM_8_CH1_PA15    = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_1  , TIM_PERIPH_8  , GPIO_PORT_A  , GPIO_PIN_ID_15 , GPIO_ALT_FUNC_3   ),
    TIM_8_CH1_PB6     = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_1  , TIM_PERIPH_8  , GPIO_PORT_B  , GPIO_PIN_ID_6  , GPIO_ALT_FUNC_3   ),
    TIM_8_CH1_PC6     = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_1  , TIM_PERIPH_8  , GPIO_PORT_C  , GPIO_PIN_ID_6  , GPIO_ALT_FUNC_3   ),

    TIM_8_CH2_PA14    = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_2  , TIM_PERIPH_8  , GPIO_PORT_A  , GPIO_PIN_ID_14 , GPIO_ALT_FUNC_3   ),
    TIM_8_CH2_PB8     = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_2  , TIM_PERIPH_8  , GPIO_PORT_B  , GPIO_PIN_ID_8  , GPIO_ALT_FUNC_3   ),
    TIM_8_CH2_PC7     = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_2  , TIM_PERIPH_8  , GPIO_PORT_C  , GPIO_PIN_ID_7  , GPIO_ALT_FUNC_3   ),

    TIM_8_CH3_PB9     = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_3  , TIM_PERIPH_8  , GPIO_PORT_B  , GPIO_PIN_ID_9  , GPIO_ALT_FUNC_3   ),
    ...
    TIM_8_CH4_PD1     = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_4  , TIM_PERIPH_8  , GPIO_PORT_D  , GPIO_PIN_ID_1  , GPIO_ALT_FUNC_3   ),
    ...
    TIM_15_CH1_PG11   = TIM_CHANNEL_PIN_BIT_MASK_ENCODE( TIM_CHANNEL_1  , TIM_PERIPH_15 , GPIO_PORT_G  , GPIO_PIN_ID_11 , GPIO_ALT_FUNC_14  ),
...
typedef enum
{
    ...
    TIM_1_BKIN_PA11     = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_1  , GPIO_PORT_A  , GPIO_PIN_ID_11 , GPIO_ALT_FUNC_2   ),
    TIM_1_BKIN_PB12     = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_1  , GPIO_PORT_B  , GPIO_PIN_ID_12 , GPIO_ALT_FUNC_1   ),
    TIM_1_BKIN_PE14     = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_1  , GPIO_PORT_E  , GPIO_PIN_ID_14 , GPIO_ALT_FUNC_2   ),
    ...
    TIM_8_BKIN_PC9      = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_8  , GPIO_PORT_C  , GPIO_PIN_ID_9  , GPIO_ALT_FUNC_1   ),
...
typedef enum
{
    ...
    TIM_1_BKIN2_PA11     = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_1  , GPIO_PORT_A  , GPIO_PIN_ID_11 , GPIO_ALT_FUNC_2   ), /**< Pin PA11 used as Break Input 2 for timer 1  */
    TIM_1_BKIN2_PE14     = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_1  , GPIO_PORT_E  , GPIO_PIN_ID_14 , GPIO_ALT_FUNC_2   ), /**< Pin PE14 used as Break Input 2 for timer 1  */

    /*----------------------------- Timer 8 pins -----------------------------*/

    TIM_8_BKIN2_PB6      = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_8  , GPIO_PORT_B  , GPIO_PIN_ID_6  , GPIO_ALT_FUNC_3   ), /**< Pin PB6 used as Break Input 2 for timer 8   */
    TIM_8_BKIN2_PC9      = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_8  , GPIO_PORT_C  , GPIO_PIN_ID_9  , GPIO_ALT_FUNC_1   ), /**< Pin PC9 used as Break Input 2 for timer 8   */
...
typedef enum
{
    ...
    TIM_1_ETR_PA12     = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_1  , GPIO_PORT_A  , GPIO_PIN_ID_12 , GPIO_ALT_FUNC_1   ), /**< Pin PA12 used as External Trigger input for timer 1 */
    TIM_1_ETR_PE7      = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_1  , GPIO_PORT_E  , GPIO_PIN_ID_7  , GPIO_ALT_FUNC_1   ), /**< Pin PE7 used as External Trigger input for timer 1  */
    ...
    TIM_2_ETR_PA15     = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_2  , GPIO_PORT_A  , GPIO_PIN_ID_15 , GPIO_ALT_FUNC_2   ), /**< Pin PA15 used as External Trigger input for timer 2 */
    ...
    TIM_3_ETR_PE2      = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_3  , GPIO_PORT_E  , GPIO_PIN_ID_2  , GPIO_ALT_FUNC_2   ), /**< Pin PE2 used as External Trigger input for timer 3  */
    ...
    TIM_8_ETR_PA0      = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_8  , GPIO_PORT_A  , GPIO_PIN_ID_0  , GPIO_ALT_FUNC_3   ), /**< Pin PA0 used as External Trigger input for timer 8  */
    TIM_8_ETR_PI3      = TIM_TIMER_PIN_BIT_MASK_ENCODE( TIM_PERIPH_8  , GPIO_PORT_I  , GPIO_PIN_ID_3  , GPIO_ALT_FUNC_3   ), /**< Pin PI3 used as External Trigger input for timer 8  */
